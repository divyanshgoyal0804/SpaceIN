...
const services = [
  {
    ...
    href: '/properties?type=COWORKING',
  },
  {
    icon: LayoutTemplate,
    ...
    href: '/properties?type=OFFICE&furnished=FURNISHED',
  },
  {
    icon: Building2,
    ...
    href: '/properties?type=OFFICE&furnished=BARE_SHELL',
  },
  {
    icon: Warehouse,
  ...
  },
  {
    ...
    href: '/properties?type=OFFICE&managed=true',
  },
];
